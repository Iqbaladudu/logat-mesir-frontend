...
const Register = () => {
	...
	return (
		<section className="overflow-hidden bg-blue-core">
			...
			>
				<Card className="w-[350px] h-[750px] sm:w-[500px] sm:h-[577px] flex-wrap rounded-[10px] xl:rounded-[30px] gap-4 bg-yellow-lm flex-col shadow-[0_8px_6px_rgba(0,0,0,0.32)]">
