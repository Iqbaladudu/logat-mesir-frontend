        ...
        <section className="overflow-hidden">
            <Container width="w-screen" height="h-[730px]">
                <div className="flex w-full h-full flex-col text-blue-secondary justify-center items-center gap-[64px] relative overflow-hidden">
                    <div className="flex flex-col text-[48px] leading-[72px] font-medium w-[537px] overflow-hidden">
                        <h1 className="text-center">Kenapa harus belajar di Logat Mesir?</h1>
                        <p className="flex justify-center text-center"><Image src={WhyUsLine} width={315} height={10} /></p>
                    </div>
                    <div className="flex justify-center items-center gap-[71px]">
                        <Card {...cardProps} />
                        <Card {...cardProps} />
                        <Card {...cardProps} />
                        <Card {...cardProps} />
                    ...
                    <div className={styles.assetsLeft}>
                        <Image src={LeftAssets} height={200} width={200} />
                    </div>
                    <div>
                        <Image src={WhyUsDots} height={10} width={47} />
                    </div>
                </div>
            </Container>
        </section>
