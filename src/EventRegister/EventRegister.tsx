		...
		<>
			{succes ? (
				...
				<div className="h-screen w-screen flex flex-col items-center justify-center bg-blue-core">
					...
					<Box className="flex justify-center items-center w-[350px] h-[50%] lg:h-[40%] min-h-[40%] sm:w-[20%] flex-wrap rounded-sm xl:rounded-sm gap-4 bg-yellow-lm flex-col shadow-[0_8px_6px_rgba(0,0,0,0.32)]">
						<Backdrop
